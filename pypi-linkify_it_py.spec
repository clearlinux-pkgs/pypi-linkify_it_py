...
%prep
%setup -q -n linkify-it-py-1.0.2
cd %{_builddir}/linkify-it-py-1.0.2
...
cp %{_builddir}/linkify-it-py-1.0.2/LICENSE %{buildroot}/usr/share/package-licenses/pypi-linkify_it_py/d5877e21ab96983663f54d8faa3eca337aaa24b9
